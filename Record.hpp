...
class Record 
{
	...
	public:
		...
		Record();
		void Add_voidElement(Patient Copy_Data, int Copy_intID);
		void Delete_voidElement(int Copy_intID);
		void GET_voidData(int Copy_intID, Patient *Copy_ptrData);
		void Clear_voidRecord(void);
		void Traverse_voidRecord(void(*func)(Patient));	
		void EDIT_voidRecord(int Copy_intID, Patient Copy_Newdata);
...
void Record::Add_voidElement(Patient Copy_Data, int Copy_intID)
{
...
void Record::GET_voidData(int Copy_intID, Patient *Copy_ptrData)
{
		Rec_Node *temp = Head;
		while( temp != NULL )
		{
...
void Record::Traverse_voidRecord(void(*func)(Patient))
{
		Rec_Node *temp = Head;
		int Counter = 0;
		while(temp != NULL)
...
void Record::EDIT_voidRecord(int Copy_intID, Patient Copy_Newdata)
{
	Rec_Node *temp = Head;
